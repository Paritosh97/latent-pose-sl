...
SKELETON = "skeletons/skeleton_azee.pt"
VPOSER   = "models/vposer_azee.pt"
...
def predict():
    if request.method == 'GET':
        ...
        joint_pos = torch.zeros((1,42,3)).type(torch.float32)
        joint_mask = torch.zeros((1,42,3)).type(torch.float32)
